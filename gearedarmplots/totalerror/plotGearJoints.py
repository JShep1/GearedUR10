...
# plot data
plt.plot(t001,y2,'r' ,label='Total Error-0.001')
plt.plot(t01, y3,'g' ,label='Total Error-0.01')
plt.plot(t05, y4,'b' ,label='Total Error-0.05')

# set limits
axPlot = plt.subplot(111)
axPlot.set_xlim(-.001, 3)
s = 'Total Error of the System for Different Timesteps';
