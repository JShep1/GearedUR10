...
y2 = pylab.loadtxt(sys.argv[1] + "001.txt")
y3 = pylab.loadtxt(sys.argv[1] + "01.txt")
y4 = pylab.loadtxt(sys.argv[1] + "05.txt")

t05  = np.linspace(0,  y1.size*DT05,y1.size)
t01  = np.linspace(0, y1.size*DT01,y1.size)
...
plt.plot(t01, y3,'g' ,label='Act-0.01')
plt.plot(t05, y4,'b' ,label='Act-0.05')
...
plt.title('Positional Error for Different Timesteps', fontdict=font)
